    ...
    <Grid container sx={{ height: '100vh', margin: 0, position: 'relative' }}>
      <Grid item xs={12} md={6} sx={styles.formContainer}>
        <Container maxWidth="xs">
          <Box sx={styles.signupBox}>{children}</Box>
        </Container>
      </Grid>
      <Grid
        item
      ...
      >
        ...
        <Box sx={styles.infoSection}>
          <Typography variant="body1">
            <strong>Welcome to our messaging app!</strong> Join us and start connecting with your friends and colleagues through seamless communication.
          </Typography>
        </Box>
        <Box sx={styles.infoSection}>
          <Typography variant="body1">
